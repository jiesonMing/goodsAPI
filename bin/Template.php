...
class Template
{
    ...
    private        $_array_config = [
        ...
        'compile_dir'  => 'bin/templates_c',    // 编译后存放的文件夹
        'cache_dir'    => 'bin/cache',          // 静态html存放地址
        'cache_htm'    => true,            // 是否编译为静态html文件
        'suffix_cache' => '.htm',           // 设置编译文件的后缀 cache
        'cache_time'   => 1,             // 自动更新间隔
    ...
    {
        $this->_array_config['root'] = str_replace('\\', '/', realpath($_SERVER['DOCUMENT_ROOT'])) . '/';
        ...
        require(DIR.'/bin/CompileClass.php');
    }
